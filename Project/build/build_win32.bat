...
@set SOURCES=src/main.cpp src/core/application_functional.cpp ..\..\ImGUI\backends\imgui_impl_glfw.cpp ..\..\ImGUI\backends\imgui_impl_opengl3.cpp ..\..\ImGUI\imgui*.cpp ..\..\ImGuiFileDialog\ImGuiFileDialog.cpp
