...
@set OUT_DIR=Build_Win32
@set OUT_EXE=PasswordManagerGUI
@set INCLUDES=/I.. /I..\ImGUI /I..\ImGUI\backends /Ilibs\glfw\include  /I..\json\include /I..\TDOM-EncryptOrDecryptFile-Reborn\include
...
mkdir %OUT_DIR%
cl /nologo /O2 /Zi /MD /utf-8 /std:c++20 /Zc:__cplusplus /Zc:preprocessor /permissive- /EHsc %INCLUDES% %SOURCES% /Fe%OUT_DIR%/%OUT_EXE%.exe /Fo%OUT_DIR%/ /link %LIBS%
